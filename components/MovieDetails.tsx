...
const MovieDetails: React.FC<MovieDetailsProps> = ({ movie, onClose, botUsername, channelLink }) => {
  ...
  return (
    <>
      ...
      >
        {/* Detail Banner - 16:9 ratio */}
        <div className="absolute top-0 left-0 w-full z-0" style={{ aspectRatio: '16/9', maxHeight: '55vh' }}>
          <img
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#000]/30 to-transparent" />
        </div>
        ...
        {/* Scrollable Content */}
        <div className="flex-1 overflow-y-auto no-scrollbar relative z-10" style={{ paddingTop: 'min(45vw, 42vh)' }}>
                              ...
                              <div className="flex items-stretch gap-0">
                                ...
                                <div className="flex-1 flex flex-col justify-between p-2.5 min-w-0">
                                  ...
                                  <div className="flex items-start justify-between gap-1 mb-1.5">
                                    ...
                                    <span className="text-[9px] font-mono text-gray-500 bg-black/40 px-1.5 py-0.5 rounded shrink-0">{ep.duration}</span>
                                  </div>
